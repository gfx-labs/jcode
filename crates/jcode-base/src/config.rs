...
pub use jcode_config_types::{
    ...
    JevConfig, KeybindingsConfig, LatexRenderingMode, LaunchHotkeyEntry, LaunchHotkeysConfig,
    ...
    SponsorsConfig, SwarmRouterConfig, SwarmSpawnMode, SwarmStripLayout, TerminalConfig,
...
const CONFIG_ENV_KEYS: &[&str] = &[
    ...
    "JCODE_SEARXNG_URL",
    "JCODE_JEV_PROVIDER",
    "JCODE_SKILL_SUGGESTION_API_KEY_ENV",
    "JCODE_SKILL_SUGGESTION_BACKEND",
    "JCODE_SKILL_SUGGESTION_BASE_URL",
    "JCODE_SKILL_SUGGESTION_MIN_CONFIDENCE",
    "JCODE_SKILL_SUGGESTION_MODEL",
