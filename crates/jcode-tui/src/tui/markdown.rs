pub use jcode_tui_markdown::{
    ...
    extract_copy_targets_from_rendered_lines, extract_streaming_copy_targets,
    handterm_native_latex_for_hash, highlight_file_lines, highlight_line,
    line_is_mermaid_pending_placeholder, mermaid_rendering_enabled, progress_bar, progress_line,
    recenter_structured_blocks_for_display, render_markdown, render_markdown_lazy,
