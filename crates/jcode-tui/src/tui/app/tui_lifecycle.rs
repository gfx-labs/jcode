...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            agent_wizard: None,
            agent_wizard_remote_cancel: None,
            agent_wizard_saved_path: None,
            ...
            pending_agent_profile: None,
            remote_agent_profile_request_id: None,
            remote_agent_profile_name: None,
