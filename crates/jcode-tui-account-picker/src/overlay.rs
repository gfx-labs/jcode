...
use crate::{AccountPickerCommand, AccountPickerItem, AccountPickerSummary, AccountProviderKind};
...
impl AccountPicker {
    ...
    fn apply_filter(&mut self) {
        self.filtered = self
            ...
            .iter()
            .enumerate()
            .filter_map(|(idx, item)| crate::item_matches_filter(item, &self.filter).then_some(idx))
            .collect();
